...
<script type="text/javascript">
       ...
       async function pesan(){
                 ...
                 await swalst.fire({
                  ...
                  await swalst.fire({
                  title: 'Semua kerja kerasmu akhirnya terbayar. Selamat atas kelulusanmu!🫣',
                  imageUrl: '' + stiker4.src,
                  });
                  
                  katangetik = "<b class='usefont2'>Terakhir, aku mau bilang:<br>Congratulations! Ini bukanlah akhir dari perjalanan akademikmu. Tapi aku yakin kamu pasti bisa menghadapi segala rintangan baru yang akan muncul di masa depan. Tetap semangat! <br> Wish You All The Best ✨</b>";
